...
### Phase 2 — `ios/FlockSquawk/` (Xcode app, device required)

| File | Responsibility |
|---|---|
| `FlockSquawkApp.swift` | App entry point |
...
**Files:**
- Create: `ios/FlockSquawk/FlockSquawk/TokenStore.swift`
- Create: `ios/FlockSquawk/FlockSquawk/LoginService.swift`
...
**Files:**
- Create: `ios/FlockSquawk/FlockSquawk/LocationProvider.swift`
...
**Files:**
- Create: `ios/FlockSquawk/FlockSquawk/PeripheralClient.swift`
...
**Files:**
- Create: `ios/FlockSquawk/FlockSquawk/SessionController.swift`
...
**Files:**
- Modify: `ios/FlockSquawk/FlockSquawk/ContentView.swift`
- Modify: `ios/FlockSquawk/FlockSquawk/FlockSquawkApp.swift`
...
- [ ] **Step 2: Prune on launch in `FlockSquawkApp.swift`**
